      ...
      <div>
        <Grid container spacing={2}> 
          ...
          <Grid item sm={8}>
            ...
            <div style={{marginTop:"10%", textAlign:"center", fontFamily:"Helvetica", marginBottom:"10px", color:'white'}}>
            ...
            <div style={{textAlign:"center", fontFamily:"Helvetica", marginBottom:"10%", color:'white'}}>
